    ...
    <div class="weather">
        <div class="block_info">
            ...
            <div class="flex_container">
                <div class="left_part">
                    <div>
                        <span class="just_text"> One dollar equals {dollar || "please wait"} rubles </span>
                    </div>
                    <div class="margin_up m1">
                        <span class="just_text">One euro equals {euro || "please wait"} rubles</span>
                    </div>
                    <div class="margin_up m2">
                        <span class="just_text">One canadian dollar equals {canDollar || "please wait"} rubles</span>
                    </div>
                    <div class="margin_up m3">
                        <span class="just_text">One Bosnia-Herzegovina Convertible Mark equals {mark || "please wait"} rubles</span>
                    </div>
                </div>
            </div>
        </div>
